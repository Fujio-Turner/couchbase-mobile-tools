...
public:
    explicit DbEndpoint(const std::string &spec, std::vector<CollectionName>);
    explicit DbEndpoint(C4Database*, std::vector<CollectionName>);
    ~DbEndpoint();
    ...
    void setCollections(std::vector<CollectionName>);
